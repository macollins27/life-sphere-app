    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-stone-200 bg-gradient-to-b from-[#4A7C59]/5 to-transparent">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8">
          <p className="mb-4 text-sm font-medium uppercase tracking-wider text-[#4A7C59]">
            The Complete Guide
          </p>
          ...
          <p className="mt-8 text-sm text-stone-500">
            Written by{" "}
            <span className="font-medium text-stone-700">{handbook.author}</span>
          </p>
        </div>
      </div>
      ...
      {/* Footer CTA */}
      <div className="border-t border-stone-200 bg-[#4A7C59]/5">
